...
public class ImageUtils {
    ...
    public static Bitmap getResizedImage(Uri uriFile, int width, int height) {
        try {
            // Carrega a imagem original em memÃ³ria
            ...
            // Limpa a memÃ³ria do arquivo original (o grande que fizemos resize)
            bitmap.recycle();
            bitmap = null;
    ...
    public static Bitmap getResizedImage2(Uri uriFile, int width, int height) {
        try {
            // Configura o BitmapFactory para apenas ler o tamanho da imagem (sem carregÃ¡-la em memÃ³ria)
            BitmapFactory.Options opts = new BitmapFactory.Options();
            opts.inJustDecodeBounds = true;
            // Faz o decode da imagem
            BitmapFactory.decodeFile(uriFile.getPath(), opts);
            // LÃª a largura e altura do arquivo
            int w = opts.outWidth;
    ...
    private static Bitmap fixMatrix(Uri uriFile, Bitmap bitmap) throws IOException {
        ...
        // LÃª a orientaÃ§Ã£o que foi salva a foto
        ...
        // Corrige a orientaÃ§Ã£o (passa a matrix)
